...
import '../../data/models/select_item_color_size_model.dart';
...
class SizeItem extends StatefulWidget {
  ...
  final void Function(SelectItemColorSizeModel? selectItemColorSizeModel) onTap;
                ...
                children: widget.itemSize.colors
                    .map(
                      (e) => Padding(
                        ...
                        child: InkWell(
                          onTap: () {
                            final select = SelectItemColorSizeModel(
